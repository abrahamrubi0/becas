...
# Hacemos un filtro de las becas entregadas y no entregadas y asi podemos visualizarlas en el template
...
# Aqui vamos a generar el reporte
def reporte(request, pk):

    response = HttpResponse(content_type='application/pdf')
    report = generarPDF(pk)
    buff = BytesIO()
# Y aqui el tamaño que lo queremos
...
# Aqui vamos a poder configurar el contenido de nuestro reporte
def generarPDF(pk):
